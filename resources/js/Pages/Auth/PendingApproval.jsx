                ...
                <div className="max-w-3xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white glass-morphism overflow-hidden shadow-sm sm:rounded-2xl relative p-12 card-hover">
                        ...
                        <div className="text-center relative z-10">
                            ...
                            <h3 className="text-3xl font-bold text-slate-900 mb-4">Verification in Progress</h3>
                            <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                                Your registration is complete! An Admin is currently reviewing your application.
                            </p>
